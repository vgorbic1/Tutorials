## Data Access Object
Data Access Object Pattern (DAO) pattern is used to separate low 
...
![dao](https://cloud.githubusercontent.com/assets/13823751/12891714/5dde14d8-ce4e-11e5-94c9-39bcb7ceae6f.jpg)

**Step One**

Create Value (Model) Object *Student.java*:
```java
...
Create DAO Interface *StudentDao.java*
```java
